...
class EditForm extends Component {
  shareNote = key => {
    let link = "";
    let noteurl =
      window.location.origin + "/sharenote/" + this.props.data.data.unique_id;
    if (key == "facebook") {
      ...
      <form onSubmit={handleSubmit(this.formSubmit.bind(this))}>
        <div className="note-detail-container">
          <div className="note-detail-top-row">
            <button className="btn btn-primary save-note" type="submit">
              Save
            </button>
            ...
            <div className="icons">
              ...
              <i
                ...
                onClick={this.shareNote.bind(this, "facebook")}
                aria-hidden="true"
              >
                <a />
              </i>
              <i
                ...
                onClick={this.shareNote.bind(this, "mail")}
                aria-hidden="true"
              >
                <a />
              </i>
              <i
                ...
                onClick={this.shareNote.bind(this, "twitter")}
                aria-hidden="true"
              >
                <a />
              </i>
              <i
                className="fa fa fa-linkedin"
                onClick={this.shareNote.bind(this, "linkedin")}
                aria-hidden="true"
              >
                <a />
              </i>
...
export default connect(
  null,
  { editNote, deleteNote, changeMode }
)(EditForm);
